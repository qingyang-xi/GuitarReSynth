function [w,h,z,u,g,xa] = plca_5d_fast_hmm( x, K, R, F, Q, iter, sh, sz, su, w, h, z, u, g, pa)
% e.g. [w,h,z,u,g,xa] = plca_5d_fast_hmm( Y', 88, 3, 5, 3, 15, 1.0, 1.0, 1.0, W, [], [], [], [], pa);
%
% An efficient temporally-constrained probabilistic model for multiple-instrument music transcription
%
% Inputs:
%  x     input distribution
%  K     number of components (i.e. pitches)
%  R     number of instrumnent sources
